...
BlockVector::BlockVector(int nBlock, int *blockStruct, dd_real value) { initialize(nBlock, blockStruct, value); }

BlockVector::~BlockVector() { terminate(); }

void BlockVector::initialize(int nBlock, int *blockStruct, dd_real value) {
...
SparseLinearSpace::SparseLinearSpace(int SDP_nBlock, int *SDP_blockStruct, int *SDP_NonZeroNumber, int SOCP_nBlock, int *SOCP_blockStruct, int *SOCP_NonZeroNumber, int LP_nBlock, bool *LP_NonZeroNumber) { initialize(SDP_nBlock, SDP_blockStruct, SDP_NonZeroNumber, SOCP_nBlock, SOCP_blockStruct, SOCP_NonZeroNumber, LP_nBlock, LP_NonZeroNumber); }

SparseLinearSpace::SparseLinearSpace(int SDP_sp_nBlock, int *SDP_sp_index, int *SDP_sp_blockStruct, int *SDP_sp_NonZeroNumber, int SOCP_sp_nBlock, int *SOCP_sp_index, int *SOCP_sp_blockStruct, int *SOCP_sp_NonZeroNumber, int LP_sp_nBlock, int *LP_sp_index) { initialize(SDP_sp_nBlock, SDP_sp_index, SDP_sp_blockStruct, SDP_sp_NonZeroNumber, SOCP_sp_nBlock, SOCP_sp_index, SOCP_sp_blockStruct, SOCP_sp_NonZeroNumber, LP_sp_nBlock, LP_sp_index); }

SparseLinearSpace::~SparseLinearSpace() { terminate(); }

// dense form of block index
void SparseLinearSpace::initialize(int SDP_nBlock, int *SDP_blockStruct, int *SDP_NonZeroNumber, int SOCP_nBlock, int *SOCP_blockStruct, int *SOCP_NonZeroNumber, int LP_nBlock, bool *LP_NonZeroNumber) {
    ...
    for (int l = 0; l < SDP_nBlock; ++l) {
        if (SDP_NonZeroNumber[l] > 0) {
            ...
            SDP_sp_block[counter].initialize(size, size, SparseMatrix::SPARSE, SDP_NonZeroNumber[l]);
            counter++;
        }
    }
...
void SparseLinearSpace::initialize(int SDP_sp_nBlock, int *SDP_sp_index, int *SDP_sp_blockStruct, int *SDP_sp_NonZeroNumber, int SOCP_sp_nBlock, int *SOCP_sp_index, int *SOCP_sp_blockStruct, int *SOCP_sp_NonZeroNumber, int LP_sp_nBlock, int *LP_sp_index) {
    // rMessage("SparseLinearSpace::initialize");
...
void SparseLinearSpace::setElement_SOCP(int block, int i, int j, dd_real ele) { rError("DenseLinearSpace:: current version does not support SOCP"); }
...
DenseLinearSpace::DenseLinearSpace(int SDP_nBlock, int *SDP_blockStruct, int SOCP_nBlock, int *SOCP_blockStruct, int LP_nBlock) { initialize(SDP_nBlock, SDP_blockStruct, SOCP_nBlock, SOCP_blockStruct, LP_nBlock); }

DenseLinearSpace::~DenseLinearSpace() { terminate(); }

void DenseLinearSpace::initialize(int SDP_nBlock, int *SDP_blockStruct, int SOCP_nBlock, int *SOCP_blockStruct, int LP_nBlock) {
...
void DenseLinearSpace::setElement_SOCP(int block, int i, int j, dd_real ele) { rError("DenseLinearSpace:: current version does not support SOCP"); }
