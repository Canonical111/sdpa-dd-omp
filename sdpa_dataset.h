...
class Solutions {
  public:
    ...
    Solutions();
    Solutions(int m, int SDP_nBlock, int *SDP_blockStruct, int SOCP_nBlock, int *SOCP_blockStruct, int LP_nBlock, dd_real lambda, ComputeTime &com);
    ~Solutions();
    void initialize(int m, int SDP_nBlock, int *SDP_blockStruct, int SOCP_nBlock, int *SOCP_blockStruct, int LP_nBlock, dd_real lambda, ComputeTime &com);
    void terminate();
